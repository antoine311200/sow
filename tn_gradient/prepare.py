...
def prepare_sow(model, target_modules, decompose: bool = True, args: SoWArgs = SoWArgs()):
    ...
    for name, module in layers_to_replace.items():
        ...
        if decompose:
            ...
            Q_major, Q_minor = Q[:, :-args.n_iter*args.rank], Q[:, -args.n_iter*args.rank:]
            R_major, R_minor = R[:-args.n_iter*args.rank, :], R[-args.n_iter*args.rank:, :]
